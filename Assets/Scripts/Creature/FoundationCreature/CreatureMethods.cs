...
public class CreatureMethods : CreatureFoundation
{
	...
	public void Clean_Up_Status ()	   
	{
		...
		if (Defects.Count > 0)
			Defects.ForEach(d => d.End_Of_Turn());
		if (Actives.Count > 0)
	...
	public void Attack_Status (Phase Which_Phase)
	{
		if (Defects.Count > 0)
		{
			Defects.ForEach(d => d.Attack_Status(Which_Phase));
		}
	...
	public void Move_Attack (Vector3 Direction) //change to attackmove
	{
		State = "MoveAttack";
